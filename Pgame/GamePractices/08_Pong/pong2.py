...
# pong2.py
# Pong with music and sound effects
...
def initMusic():
    global hitPaddle, hitWall, scorePoint, bye
    ...
    # load sounds effects; set their volumes
    hitPaddle = pygame.mixer.Sound("hitPaddle.wav")         
    hitPaddle.set_volume(0.4)    
                            
    hitWall = pygame.mixer.Sound("hitWall.wav")      
    hitWall.set_volume(0.4)   
                        
    scorePoint = pygame.mixer.Sound("scorePoint.wav")    
    scorePoint.set_volume(0.2)  
                        
    bye = pygame.mixer.Sound("gameOver.wav")          
    bye.set_volume(0.6)                                
